...
plt = plot(etanu, k0 .* 1e6,color=:black,marker=:o,ylabel=raw"$k_0$ [ $\times 10^{-6}$ fs$^{-1}$]",xlabel=raw"$\eta_{\nu}$",ylim=(3,10),lw=2,markersize=4,size=(300,200),dpi=300,legend=nothing)
